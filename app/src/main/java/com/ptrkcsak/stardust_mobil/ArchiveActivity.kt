...
class ArchiveActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.settings -> {
                    startActivity(Intent(this@ArchiveActivity, ProfileActivity::class.java))
                    true
                }
                R.id.archive -> {
                    startActivity(Intent(this@ArchiveActivity, ArchiveActivity::class.java))
                    true
                }
                R.id.bin -> {
                    startActivity(Intent(this@ArchiveActivity, BinActivity::class.java))
                    true
                }
                R.id.devlog -> {
                    true
    ...
    fun unarchiveNote(noteId: String) {
        ...
        val service = retrofit.create(ApiInterface::class.java)
        CoroutineScope(Dispatchers.IO).launch {
            val response = service.unarchiveNote(noteId)
            withContext(Dispatchers.Main) {
                if (response.isSuccessful) {
